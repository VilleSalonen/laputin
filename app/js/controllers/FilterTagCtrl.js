function FilterTagCtrl($scope) {
    $scope.andOperatorOn = function () {
        return $scope.tag.operator === "AND";
    };

    $scope.orOperatorOn = function () {
        return $scope.tag.operator === "OR";
    };

    $scope.notOperatorOn = function () {
        return $scope.tag.operator === "NOT";
    };
